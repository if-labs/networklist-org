...
function Home({ changeTheme, theme }) {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>ChainPortal</title>
        <link rel="icon" href="/favicon.ico" />
        <meta name="description" content="ChainPortal is a list of EVM networks, continuing the Chainlist project after their shutdown. Users can use the information to connect their wallets (such as Metamask) and Web3 middleware providers to the appropriate Chain ID and Network ID to connect to the correct chain."/>
      </Head>
        ...
        <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>ChainPortal</span></Typography>
              <Typography variant='h2' className={ classes.helpingParagraph }>Helping users connect to EVM powered networks</Typography>
              <Typography className={classes.subTitle}>ChainPortal is a list of EVM networks. Inherited from Chainlist. Users can use the information to connect their wallets and Web3 middleware providers to the appropriate Chain ID and Network ID to connect to the correct chain.</Typography>
              <Button
                size='large'
                color='primary'
                variant='contained'
              ...
              <div className={ classes.socials }>
                <a className={ `${classes.socialButton}` } href='https://github.com/if-labs/networklist-org.git' target='_blank' rel="noopener noreferrer" >
                ...
                <Typography variant='subtitle1' className={classes.forkedFromChainlist}>
                  <a className={`${classes.socialButton}`} href='https://github.com/antonnell/networklist-org.git' target='_blank' rel="noopener noreferrer" >
                    Forked from Chainlist by IF Labs.
                  </a>
                </Typography>
              </div>
            </div>
